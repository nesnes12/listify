...
import 'package:listify/updateTask.dart';
          ...
          if (!snapshot.hasData) {
            ...
            return ListView(
              children: snapshot.data!.docs.map((DocumentSnapshot document) {
                ...
                Color taskColor = AppColors.saffron;
                var taskTag = data['taskTag'];
                if (taskTag == 'Work') {
                  taskColor = AppColors.coral;
                } else if (taskTag == 'School') {
                  taskColor = AppColors.pistachio;
                }
                return Container(
                  height: 80,
